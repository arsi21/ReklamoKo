        ...
        <section id="content" class="content">
            ...
            <div class="content__body__cont">
                <div class="content__search__cont">
                    ...
                    <input class="content__search" id="searchInput" type="search" name="search" placeholder="Search applicant name">
                </div>
...
<script src="js/searchSubmittedApplications.js"></script>
